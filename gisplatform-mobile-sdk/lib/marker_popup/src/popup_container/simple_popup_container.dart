...
import 'package:flutter_vnpt_map/marker_popup/src/popup_builder.dart';
...
class _SimplePopupContainerState extends State<SimplePopupContainer>
  ...
  void initState() {
    super.initState();
    _popupEventSubscription =
        widget.popupController.streamController!.stream.listen(
      (PopupEvent popupEvent) => handleAction(popupEvent),
    );
