...
class ContactExcludeGroup extends GetView<ContactExcludeGroupController> {
  const ContactExcludeGroup({Key? key}) : super(key: key);
      ...
      () => ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            child: GetX<ContactExcludeGroupController>(builder: (_) {
  ...
  List<Widget> getListSosNoTagWidget(List<SosItemModel> items) {
    ...
    for (var element in items) {
      listWidget.add(ListTile(
        onTap: () {
          launchUrl(Uri.parse("tel:${element.phoneNumber}"));
        },
