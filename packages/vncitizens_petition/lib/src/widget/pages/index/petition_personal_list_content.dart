...
import 'package:vncitizens_petition/src/widget/pages/index/petition_personal_list_item.dart';

class PetitionPersonalListContent extends StatelessWidget {
  PetitionPersonalListContent({Key? key}) : super(key: key);
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          if (index == _controller.petitions.length - 1 &&
                            ...
                            return PetitionPersonalListItem(index: index);
                          }
                        },
