...
import '../create/petition_create.dart';

class PetitionPublicListItem extends StatelessWidget {
  PetitionPublicListItem({Key? key, required this.index}) : super(key: key);
