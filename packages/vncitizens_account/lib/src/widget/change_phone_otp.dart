...
class ChangePhoneOtp extends GetView<ChangePhoneOtpController> {
  const ChangePhoneOtp({Key? key}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: Text("ma xac thuc da duoc gui den so dien thoai".tr),
                  ),
                  const SizedBox(height: 16),
                  Center(
                    child: Obx(() => Text(controller.phoneNumber.value, style: const TextStyle(fontWeight: FontWeight.bold))),
                  ),
                        ...
                        child: Obx(
                            ...
                            style: ButtonStyle(
                                ...
                                backgroundColor: MaterialStateProperty.all(
                                    controller.disableResent.value ? const Color(0xFFD4D4D4) : Colors.white)),
                            child: Text(
